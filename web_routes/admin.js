...
router.delete("/admin/delete_category", web_adminController.delete_product_category)
router.put("/admin/update_category", web_adminController.update_product_category)
